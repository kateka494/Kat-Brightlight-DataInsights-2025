...
Power BI -Interactive Data Visualization & Advanced Dashboarding
Miro -Storyboarding
Canva - Presentation Design & Branding

# 📐 Data Dimensions (Breakdowns):
The data is sliced along several key dimensions:

🏢 Overall Business: Top-level totals.

📍 Store Location: Performance across three physical locations.

📦 Product Category: Sales performance by product type (e.g., Coffee, Bakery, Tea).

💰 Quantity Bucket: Segments transactions as "Low," "Mid," or "High" value.

🍂❄️🌱 Season: Sales distribution across Winter, Spring, and Summer.

🕘 Time of Day: Sales performance in Morning, Afternoon, and Evening.

👥 Spender Bucket: Classifies customers as "Low," "Mid," "High," or "Out of Range" spenders based on transaction value.
